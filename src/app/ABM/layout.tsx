...
export default function ABMLayout({
  ...
  const navLinks = [
    { href: '/ABM', label: 'Home', icon: <HomeIcon /> },
    { href: '/ABM/report', label: 'Report', icon: <ReportIcon /> },
    { href: '/ABM/leaderboard', label: 'View Leaderboard', icon: <LeaderboardIcon /> },
    { href: '/ABM/profile', label: 'Profile', icon: <ProfileIcon /> },
  ];
