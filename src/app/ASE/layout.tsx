...
const PassbookIcon = () => (
  <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1.75 2.375H7C7.92826 2.375 8.8185 2.70863 9.47487 3.3025C10.1313 3.89636 10.5 4.70181 10.5 5.54167V16.625C10.5 15.9951 10.2234 15.391 9.73116 14.9456C9.23887 14.5002 8.57119 14.25 7.875 14.25H1.75V2.375Z" stroke="currentColor" strokeWidth="1.875" />
    <path d="M19.25 2.375H14C13.0717 2.375 12.1815 2.70863 11.5251 3.3025C10.8687 3.89636 10.5 4.70181 10.5 5.54167V16.625C10.5 15.9951 10.7766 15.391 11.2688 14.9456C11.7611 14.5002 12.4288 14.25 13.125 14.25H19.25V2.375Z" stroke="currentColor" strokeWidth="1.875" />
  </svg>
);
...
const LeaderboardIcon = () => (
  <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_3962_107281)">
      <path d="M4.5 7.12508H3.375C2.87772 7.12508 2.40081 6.91656 2.04917 6.5454C1.69754 6.17423 1.5 5.67082 1.5 5.14591C1.5 4.62101 1.69754 4.1176 2.04917 3.74643C2.40081 3.37527 2.87772 3.16675 3.375 3.16675H4.5" stroke="currentColor" strokeWidth="1.875" />
      <path d="M13.5 7.12508H14.625C15.1223 7.12508 15.5992 6.91656 15.9508 6.5454C16.3025 6.17423 16.5 5.67082 16.5 5.14591C16.5 4.62101 16.3025 4.1176 15.9508 3.74643C15.5992 3.37527 15.1223 3.16675 14.625 3.16675H13.5" stroke="currentColor" strokeWidth="1.875" />
      <path d="M3 17.4167H15" stroke="currentColor" strokeWidth="1.875" />
      <path d="M7.5 11.606V13.4585C7.5 13.8939 7.1475 14.2343 6.7725 14.4164C5.8875 14.8439 5.25 16.0235 5.25 17.4168" stroke="currentColor" strokeWidth="1.875" />
      <path d="M10.5 11.606V13.4585C10.5 13.8939 10.8525 14.2343 11.2275 14.4164C12.1125 14.8439 12.75 16.0235 12.75 17.4168" stroke="currentColor" strokeWidth="1.875" />
      <path d="M13.5 1.58325H4.5V7.12492C4.5 8.3847 4.97411 9.59288 5.81802 10.4837C6.66193 11.3745 7.80653 11.8749 9 11.8749C10.1935 11.8749 11.3381 11.3745 12.182 10.4837C13.0259 9.59288 13.5 8.3847 13.5 7.12492V1.58325Z" stroke="currentColor" strokeWidth="1.875" />
    </g>
    <defs>
...
export default function ASELayout({ children }: { children: ReactNode }) {
  ...
  const navLinks = [
    { href: '/ASE', label: 'Home', icon: <HomeIcon /> },
    { href: '/ASE/report', label: 'Report', icon: <ReportIcon /> },
    { href: '/ASE/passbook', label: 'Passbook', icon: <PassbookIcon /> },
    { href: '/ASE/leaderboard', label: 'View Leaderboard', icon: <LeaderboardIcon /> },
    { href: '/ASE/profile', label: 'Profile', icon: <ProfileIcon /> },
  ];
