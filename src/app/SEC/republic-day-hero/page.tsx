    ...
    return (
        ...
        >
            ...
            <main className="relative z-10 container mx-auto px-4 py-2 flex flex-col h-screen max-w-5xl">
                ...
                {/* Modals */}
                <AnimatePresence>
                    {showTerms && <TermsModal isOpen={showTerms} onClose={closeTerms} />}
                    {showRewards && <RewardsModal isOpen={showRewards} onClose={closeRewards} currentRankIndex={currentRankIndex} />}
                </AnimatePresence>
            </main>
