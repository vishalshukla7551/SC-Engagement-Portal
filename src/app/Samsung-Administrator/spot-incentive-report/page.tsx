  ...
  const reports: Report[] = [
    {
      ...
      secId: 'SEC001',
      storeName: 'Croma- A103 -Noida-Gaur Mall',
    ...
    },
    {
      ...
      dateOfSale: '2025-11-15',
      secId: 'SEC002',
      storeName: 'Croma- A405 - Vapi-GIDC',
    ...
    },
    {
      ...
      dateOfSale: '2025-11-15',
      secId: 'SEC003',
      storeName: 'VS- Pune(Chinchwad) Br',
    ...
    },
    {
      ...
      dateOfSale: '2025-11-15',
      secId: 'SEC005',
      storeName: 'Croma- A03B - Mumbai-Ghatkopar Mall',
    ...
    },
    {
      ...
      dateOfSale: '2025-11-15',
      secId: 'SEC006',
      storeName: 'VS- Chakala Andheri Br',
    ...
    },
    {
      ...
      dateOfSale: '2025-11-15',
      secId: 'SEC007',
      storeName: 'Croma- A151 -Noida- Mall of India',
      ...
      <aside className="w-64 bg-black border-r border-gray-800 flex flex-col">
        ...
        <nav className="p-3 flex-1">
          <Link 
            ...
            className="flex items-center gap-2 px-3 py-2.5 rounded-lg hover:bg-gray-800 transition-colors mb-1 text-sm text-white"
          >
          ...
          <Link 
            ...
            className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 transition-colors text-sm text-white"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="w-[12%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Timestamp</th>
                    <th className="w-[9%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Date of Sale</th>
                    <th className="w-[7%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">SEC ID</th>
                    <th className="w-[16%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Store Name</th>
                    <th className="w-[13%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Device Name</th>
                    <th className="w-[9%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Plan Type</th>
                    <th className="w-[12%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">IMEI</th>
                    <th className="w-[11%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Incentive Earned</th>
                    <th className="w-[11%] px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Status</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  {reports.map((report) => (
                    <tr key={report.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4 text-sm text-gray-900">{report.timestamp}</td>
                      <td className="px-4 py-4 text-sm text-gray-900">{report.dateOfSale}</td>
                      <td className="px-4 py-4 text-sm font-medium text-gray-900">{report.secId}</td>
                      <td className="px-4 py-4 text-sm text-gray-900">
                        <div className="font-semibold">{report.storeName}</div>
                      </td>
                      <td className="px-4 py-4 text-sm text-gray-900">{report.deviceName}</td>
                      <td className="px-4 py-4 text-sm text-gray-900">{report.planType}</td>
                      <td className="px-4 py-4 text-sm text-gray-900 font-mono">{report.imei}</td>
                      <td className="px-4 py-4 text-sm font-bold text-emerald-600">
                        ₹{report.incentiveEarned}
                      </td>
