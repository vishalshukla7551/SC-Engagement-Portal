...
export default function ZSEPage() {
  ...
  const cards = [
    { title: 'Incentive Passbook', description: 'Track your earnings', href: '/ZSE/passbook', badge: '₹12,450 Available', color: 'green' as const, icon: <WalletIcon /> },
  ...
  return <ChristmasDashboard userName={zseName} loading={loading} cards={cards} hideSanta={true} />;
}
