...
const PassbookIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="7" width="16" height="11" rx="2" stroke="currentColor" strokeWidth="2" fill="none"/>
    <path d="M4 9C4 7.89543 4.89543 7 6 7H18C19.1046 7 20 7.89543 20 9V10H4V9Z" fill="currentColor" fillOpacity="0.9"/>
...
export default function ZSELayout({
  ...
  const navLinks = [
    { href: '/ZSE', label: 'Home', icon: <HomeIcon /> },
    { href: '/ZSE/report', label: 'Report', icon: <ReportIcon /> },
    { href: '/ZSE/passbook', label: 'Passbook', icon: <PassbookIcon /> },
    { href: '/ZSE/leaderboard', label: 'View Leaderboard', icon: <LeaderboardIcon /> },
    { href: '/ZSE/profile', label: 'Profile', icon: <ProfileIcon /> },
  ];
