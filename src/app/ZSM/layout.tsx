...
export default function ZSMLayout({
  ...
  const navLinks = [
    { href: '/ZSM', label: 'Home', icon: <HomeIcon /> },
    { href: '/ZSM/report', label: 'Report', icon: <ReportIcon /> },
    { href: '/ZSM/leaderboard', label: 'View Leaderboard', icon: <LeaderboardIcon /> },
    { href: '/ZSM/profile', label: 'Profile', icon: <ProfileIcon /> },
  ];
