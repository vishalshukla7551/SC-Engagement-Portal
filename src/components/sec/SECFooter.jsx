...
export default function SECFooter() {
  ...
  const getActiveTab = () => {
    ...
    if (pathname.includes('/IncentiveCalculator')) {
      return 'calculator';
    }
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-black text-white z-50 shadow-[0_-4px_12px_rgba(0,0,0,0.3)]">
      <div className="flex justify-around items-center py-2.5 sm:py-3 md:py-4">
        ...
        <Link href="/IncentiveCalculator" className={linkClasses('calculator')}>
          <svg
            className={iconClasses('calculator')}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25V13.5zm0 2.25h.008v.008H8.25v-.008zm0 2.25h.008V18H8.25v-.75zm2.498-6.75h.007v.008h-.007v-.008zm0 2.25h.007v.008h-.007V13.5zm0 2.25h.007v.008h-.007v-.008zm0 2.25h.007V18h-.007v-.75zm2.504-6.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V13.5zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008V18h-.008v-.75zm2.498-6.75h.008v.008h-.008v-.008zM8.25 6h7.5v2.25h-7.5V6zM12 2.25c-1.892 0-3.758.11-5.593.322C5.307 2.7 4.5 3.65 4.5 4.757V19.5a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V4.757c0-1.108-.806-2.057-1.907-2.185A48.507 48.507 0 0012 2.25z"
            />
          </svg>
          <span className={`${labelClasses('calculator')} text-center leading-tight`}>Incentive<br/>Calculator</span>
        </Link>
      </div>
